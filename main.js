...
random_sketch_name = quick_draw_data_set[random_no];
document.getElementById("sketch_draw").innerHTML = "sketch to be drawn: " + random_sketch_name;


console.log(random_no);
console.log(random_sketch_name);
